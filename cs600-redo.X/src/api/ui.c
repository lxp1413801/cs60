...
void ui_disp_menu_edp_z_adj(void)
{
	
	
}

void ui_disp_menu_edp_l_adj(void)
{
	
	
}

void ui_disp_menu_edp_ilp_lo_adj(void)
{
	
}

void ui_disp_menu_edp_ilp_hi_adj(void)
{
...
void ui_disp_menu(void)
{
	switch(menu){
		...
		case MENU_SET_SIZE:				ui_disp_menu_pos_adj();			break;
		...
		//MENU_SET_WARN_TYPE:
		case sub_MENU_SET_WARN_TYPE_0:
		case sub_MENU_SET_WARN_TYPE_1:
		case sub_MENU_SET_WARN_TYPE_2:
		case sub_MENU_SET_WARN_TYPE_3:	ui_disp_menu_warn_t_adj();		break;
		//MENU_SET_WARN_VALUE:
		//case 
		case MENU_SET_WARN_VALUE:		ui_disp_menu_warn_v_adj();		break;
		
		case MENU_SET_EX_D_PR_ZERO:		ui_disp_menu_edp_z_adj();		break;
		case MENU_SET_EX_D_PR_ILOOP_L:	ui_disp_menu_edp_ilp_lo_adj();	break;
