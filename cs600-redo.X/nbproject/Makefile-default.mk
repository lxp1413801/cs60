...
SOURCEFILES_QUOTED_IF_SPACED=src/api/data.c src/api/key_menu.c src/api/ui.c src/app/event.c src/app/main.c src/depend/crc16.c src/depend/m_string.c src/driver/ad421.c src/driver/ads1115.c src/driver/ex_eeprom.c src/driver/ex_pwr.c src/driver/i2c.c src/driver/iic_gpio.c src/driver/in_adc.c src/driver/key.c src/driver/lcd.c src/driver/m_flash.c src/driver/m_gpio.c src/driver/uart.c src/soc/clock.c src/soc/int.c src/soc/rtc.c src/soc/soc.c src/soc/ticker.c src/api/sample.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/src/api/data.p1 ${OBJECTDIR}/src/api/key_menu.p1 ${OBJECTDIR}/src/api/ui.p1 ${OBJECTDIR}/src/app/event.p1 ${OBJECTDIR}/src/app/main.p1 ${OBJECTDIR}/src/depend/crc16.p1 ${OBJECTDIR}/src/depend/m_string.p1 ${OBJECTDIR}/src/driver/ad421.p1 ${OBJECTDIR}/src/driver/ads1115.p1 ${OBJECTDIR}/src/driver/ex_eeprom.p1 ${OBJECTDIR}/src/driver/ex_pwr.p1 ${OBJECTDIR}/src/driver/i2c.p1 ${OBJECTDIR}/src/driver/iic_gpio.p1 ${OBJECTDIR}/src/driver/in_adc.p1 ${OBJECTDIR}/src/driver/key.p1 ${OBJECTDIR}/src/driver/lcd.p1 ${OBJECTDIR}/src/driver/m_flash.p1 ${OBJECTDIR}/src/driver/m_gpio.p1 ${OBJECTDIR}/src/driver/uart.p1 ${OBJECTDIR}/src/soc/clock.p1 ${OBJECTDIR}/src/soc/int.p1 ${OBJECTDIR}/src/soc/rtc.p1 ${OBJECTDIR}/src/soc/soc.p1 ${OBJECTDIR}/src/soc/ticker.p1 ${OBJECTDIR}/src/api/sample.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/src/api/data.p1.d ${OBJECTDIR}/src/api/key_menu.p1.d ${OBJECTDIR}/src/api/ui.p1.d ${OBJECTDIR}/src/app/event.p1.d ${OBJECTDIR}/src/app/main.p1.d ${OBJECTDIR}/src/depend/crc16.p1.d ${OBJECTDIR}/src/depend/m_string.p1.d ${OBJECTDIR}/src/driver/ad421.p1.d ${OBJECTDIR}/src/driver/ads1115.p1.d ${OBJECTDIR}/src/driver/ex_eeprom.p1.d ${OBJECTDIR}/src/driver/ex_pwr.p1.d ${OBJECTDIR}/src/driver/i2c.p1.d ${OBJECTDIR}/src/driver/iic_gpio.p1.d ${OBJECTDIR}/src/driver/in_adc.p1.d ${OBJECTDIR}/src/driver/key.p1.d ${OBJECTDIR}/src/driver/lcd.p1.d ${OBJECTDIR}/src/driver/m_flash.p1.d ${OBJECTDIR}/src/driver/m_gpio.p1.d ${OBJECTDIR}/src/driver/uart.p1.d ${OBJECTDIR}/src/soc/clock.p1.d ${OBJECTDIR}/src/soc/int.p1.d ${OBJECTDIR}/src/soc/rtc.p1.d ${OBJECTDIR}/src/soc/soc.p1.d ${OBJECTDIR}/src/soc/ticker.p1.d ${OBJECTDIR}/src/api/sample.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/src/api/data.p1 ${OBJECTDIR}/src/api/key_menu.p1 ${OBJECTDIR}/src/api/ui.p1 ${OBJECTDIR}/src/app/event.p1 ${OBJECTDIR}/src/app/main.p1 ${OBJECTDIR}/src/depend/crc16.p1 ${OBJECTDIR}/src/depend/m_string.p1 ${OBJECTDIR}/src/driver/ad421.p1 ${OBJECTDIR}/src/driver/ads1115.p1 ${OBJECTDIR}/src/driver/ex_eeprom.p1 ${OBJECTDIR}/src/driver/ex_pwr.p1 ${OBJECTDIR}/src/driver/i2c.p1 ${OBJECTDIR}/src/driver/iic_gpio.p1 ${OBJECTDIR}/src/driver/in_adc.p1 ${OBJECTDIR}/src/driver/key.p1 ${OBJECTDIR}/src/driver/lcd.p1 ${OBJECTDIR}/src/driver/m_flash.p1 ${OBJECTDIR}/src/driver/m_gpio.p1 ${OBJECTDIR}/src/driver/uart.p1 ${OBJECTDIR}/src/soc/clock.p1 ${OBJECTDIR}/src/soc/int.p1 ${OBJECTDIR}/src/soc/rtc.p1 ${OBJECTDIR}/src/soc/soc.p1 ${OBJECTDIR}/src/soc/ticker.p1 ${OBJECTDIR}/src/api/sample.p1

# Source Files
SOURCEFILES=src/api/data.c src/api/key_menu.c src/api/ui.c src/app/event.c src/app/main.c src/depend/crc16.c src/depend/m_string.c src/driver/ad421.c src/driver/ads1115.c src/driver/ex_eeprom.c src/driver/ex_pwr.c src/driver/i2c.c src/driver/iic_gpio.c src/driver/in_adc.c src/driver/key.c src/driver/lcd.c src/driver/m_flash.c src/driver/m_gpio.c src/driver/uart.c src/soc/clock.c src/soc/int.c src/soc/rtc.c src/soc/soc.c src/soc/ticker.c src/api/sample.c
...
${OBJECTDIR}/src/api/data.p1: src/api/data.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit3  --double=32 --float=32 --emi=wordwrite --rom=0-f3ff --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --fill=0xaa --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:300:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/src/api/data.p1  src/api/data.c 
...
${OBJECTDIR}/src/api/data.p1: src/api/data.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/src/api/data.p1.d 
	@${RM} ${OBJECTDIR}/src/api/data.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  --double=32 --float=32 --emi=wordwrite --rom=0-f3ff --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --fill=0xaa --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:300:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/src/api/data.p1  src/api/data.c 
	@-${MV} ${OBJECTDIR}/src/api/data.d ${OBJECTDIR}/src/api/data.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/src/api/data.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
dist/${CND_CONF}/${IMAGE_TYPE}/cs600-redo.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/cs600-redo.X.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=32 --float=32 --emi=wordwrite --rom=0-f3ff --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --fill=0xaa --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:300:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/cs600-redo.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/cs600-redo.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/cs600-redo.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/cs600-redo.X.${IMAGE_TYPE}.map  --double=32 --float=32 --emi=wordwrite --rom=0-f3ff --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --fill=0xaa --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:300:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/cs600-redo.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
